document.addEventListener("DOMContentLoaded", function () {
  ...
  const groupsNur = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          name: "Мумтаз",
          address:
            "Қобыланды батыр, <strong>3</strong>, Мечеть <strong>Aq Meshit</strong> цокольный этаж",
        },
        {
        ...
        },
        {
          ...
          name: "Caviar Hause",
          address:
            "Петрова, <strong>24</strong>, <strong>Евразия-1</strong> цокольный этаж, 099 бутик",
        },
        {
  ...
  const groupsTaraz = [
    {
      ...
      items: [
        ...
        {
          center: [42.63696, 70.695285],
          logo: "images/магазин.webp",
          name: "магазин Жанна",
          address: "Село <strong>Карасаз</strong>",
        },
        {
          center: [43.07959, 71.455256],
          logo: "images/магазин.webp",
  ...
  setTimeout(() => {
    ymaps.ready(() =>
      init(groupsAlmaty, centerAlmaty, "mapAlmaty", ".map-Almaty", 20)
    );
    ymaps.ready(() => init(groupsNur, centerNur, "mapNur", ".map-Nur", 20));
    ymaps.ready(() =>
      init(groupsTaraz, centerTaraz, "mapTaraz", ".map-Taraz", 20)
    );
